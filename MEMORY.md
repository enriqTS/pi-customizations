...
- The Debian Node image is intentionally retained as a small general-purpose base and adds Python/uv/ruff, Rust/Cargo/rustfmt, Terraform 1.11.4, and native-build prerequisites. Tool caches use `/tmp` because the OpenShell filesystem policy does not allow writes to the general home directory.
